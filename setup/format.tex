...
% \def\mailbox#1{\def\@mailbox{#1}}\def\@mailbox{}
\def\teacher#1{\def\@teacher{#1}}\def\@teacher{}
\def\cauthorextend#1{\def\@cauthorextend{#1}}\def\@cauthorextend{}
\def\cnumber#1{\def\@cnumber{#1}}\def\@cnumber{}
\def\cstuid#1{\def\@cstuid{#1}}\def\@cstuid{}
\def\cstuidextend#1{\def\@cstuidextend{#1}}\def\@cstuidextend{}
...
%\cleardoublepage%
   \phantomsection
    ...
    \begin{titlepage}
      ...
      \setlength{\@title@width}{8 cm}
      {
        \sanhao\song{
          \begin{tabular}{lc}
            % \textbf{邮\qquad 箱}  &  \underline{\makebox[\@title@width][c]{\textbf{\@mailbox}}}\\
            ...
            % \textbf{班\qquad 级}  &  \underline{\makebox[\@title@width][c]{\textbf{\@cclass}}}\\
            \textbf{任课教师}  &  \underline{\makebox[\@title@width][c]{\textbf{\@teacher}}}\\
            \textbf{姓\qquad 名}  &  \underline{\makebox[\@title@width][c]{\textbf{\@cauthor}}}\\
            \textbf{\qquad }  &  \underline{\makebox[\@title@width][c]{\textbf{\@cauthorextend}}}\\
            \textbf{学\qquad 号}  &  \underline{\makebox[\@title@width][c]{\textbf{\@cstuid}}}\\
             \textbf{\qquad }  &  \underline{\makebox[\@title@width][c]{\textbf{\@cstuidextend}}}\\
